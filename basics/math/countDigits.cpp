...
int main() {
    int N = 329823;
    cout << "N: "<< N << endl;
    int digitsBrute = countDigitsBrute(N);
    int dightsOptimal = countDigitsOptimal(N);
    cout << "Number of Digits in N: "<< digitsBrute << endl;
    cout << "Number of Digits in N: "<< dightsOptimal << endl;
    return 0;
}
